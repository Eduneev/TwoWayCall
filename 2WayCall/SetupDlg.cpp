...
void CSetupDlg::InitData()
{
	...
	m_szProfileDes[2] = _T("320x240 15fps");//200kbps
	m_nProfileValue[2] = 20;
	...
	m_szProfileDes[5] = _T("1280x720 15fps"); //1130kbps
	m_nProfileValue[5] = 50;
	
	m_szProfileDes[6] = _T("1280x720 30fps"); //1710kbps
	m_nProfileValue[6] = 52;
	/*
