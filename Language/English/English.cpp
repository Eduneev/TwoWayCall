...
ENGLISH_API LPCTSTR IDS_TITLE = _T("2WayCall - Classroom");
ENGLISH_API LPCTSTR IDS_LOGO_DESC = _T("");
ENGLISH_API LPCTSTR IDS_LOGO_AGORAWEB = _T("2WayCall");
...
ENGLISH_API LPCTSTR IDS_CHN_BTJOIN = _T("Manual Connect (Don't press unless asked)");
ENGLISH_API LPCTSTR IDS_CHN_BTCHANNEL = _T("Set Channel");
...
ENGLISH_API LPCTSTR IDS_CHN_CHANNELNAME = _T("Channel");
...
ENGLISH_API LPCTSTR IDS_WEBSOCKET_PROVIDER = _T("2WayLive");